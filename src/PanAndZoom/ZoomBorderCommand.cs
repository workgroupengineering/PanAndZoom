...
/// <summary>
/// A simple ICommand implementation with parameter for ZoomBorder operations.
/// </summary>
/// <typeparam name="T">The type of the command parameter.</typeparam>
internal class ZoomBorderCommand<T> : ICommand
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ZoomBorderCommand{T}"/> class.
    /// </summary>
    /// <param name="execute">The action to execute.</param>
    /// <param name="canExecute">The function that determines if the command can execute.</param>
    public ZoomBorderCommand(Action<T?> execute, Func<T?, bool>? canExecute = null)
    {
        _execute = execute ?? throw new ArgumentNullException(nameof(execute));
        _canExecute = canExecute;
    }
